...
REQUIRED_MESSAGE_IDS: tuple[str, ...] = (
    ...
    "service.apply.expected_skips.title",
    "service.apply.expected_skips.item",
    "service.apply.skip_reason.bot_managed_role",
    "service.apply.skip_reason.role_hierarchy_restriction",
    "render.diff.title",
    "render.diff.summary_line",
    "render.diff.column.action",
    "render.diff.column.target_type",
    "render.diff.column.target_id",
    "render.diff.column.current_server_name",
    "render.diff.column.config_file_name",
    "render.diff.column.applied_name",
    "render.diff.column.risk",
    "render.diff.column.bot_managed",
    "render.diff.column.apply_skip_reason",
    "render.diff.column.current_server",
    "render.diff.column.config_file",
    "render.diff.column.applied",
    "render.skip_reason.bot_managed_role",
    "render.skip_reason.role_hierarchy_restriction",
    "render.apply.title",
